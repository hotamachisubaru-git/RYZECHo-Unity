...
internal sealed class ProgressProfile
{
    ...
    public List<string> UnlockedAgents { get; set; } = new List<string>(new[] { "ヴェール" });
    public List<string> UnlockedStructureSkins { get; set; } = new List<string>(new[] { "シグナル標準" });
    public List<string> UnlockedAdThemes { get; set; } = new List<string>(new[] { "NEO CORE" });
    public List<string> UnlockedBanners { get; set; } = new List<string>(new[] { "SIGNAL//STANDARD" });
    public List<string> UnlockedKillEffects { get; set; } = new List<string>(new[] { "SIGNAL BURST" });
