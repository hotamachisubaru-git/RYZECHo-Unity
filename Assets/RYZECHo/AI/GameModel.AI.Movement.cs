...
internal sealed partial class GameModel
{
    ...
    private void FollowPathActor(Actor actor, float deltaSeconds, bool emitFootsteps)
    {
        ...
        var vector = new Vector2(waypoint.X - actor.Position.X, waypoint.Y - actor.Position.Y);
        ...
        vector = new Vector2(vector.X / length, vector.Y / length);
        ...
        var next = new Vector2(actor.Position.X + (vector.X * speed * deltaSeconds), actor.Position.Y + (vector.Y * speed * deltaSeconds));
