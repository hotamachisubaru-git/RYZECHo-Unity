...
internal sealed partial class GameModel
{
    ...
    private bool UseAutonomousAbility(Actor actor, AgentAbilitySlot slot, Actor? target, Vector2 targetPoint)
    {
        return actor.Agent switch
        {
    ...
    private bool UseAutonomousVeilAbility(Actor actor, AgentAbilitySlot slot, Vector2 targetPoint)
    {
        return slot switch
        {
    ...
    private bool UseAutonomousVineAbility(Actor actor, AgentAbilitySlot slot, Actor? target, Vector2 targetPoint)
    {
        switch (slot)
        {
    ...
    private bool UseAutonomousNitroAbility(Actor actor, AgentAbilitySlot slot, Actor? target, Vector2 targetPoint)
    {
        switch (slot)
        {
            case AgentAbilitySlot.SkillOne:
    ...
    private bool UseAutonomousOasisAbility(Actor actor, AgentAbilitySlot slot, Vector2 targetPoint)
    {
        switch (slot)
        {
            case AgentAbilitySlot.SkillOne:
    ...
    private bool UseAutonomousDivideAbility(Actor actor, AgentAbilitySlot slot, Vector2 targetPoint)
    {
        return slot switch
        {
    ...
    private bool UseAutonomousGlitchAbility(Actor actor, AgentAbilitySlot slot, Actor? target, Vector2 targetPoint)
    {
        switch (slot)
        {
            case AgentAbilitySlot.SkillOne:
    ...
    private bool AddAutonomousWorldEffect(Actor actor, WorldEffectKind kind, Vector2 position, float radius, float lifetime, string label)
    {
    ...
    private bool TryPlaceAutonomousTemporaryStructure(Actor actor, BuildToolKind tool, Vector2 targetPoint, float lifetime, string label)
    {
