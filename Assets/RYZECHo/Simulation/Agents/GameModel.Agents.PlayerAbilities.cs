...
{
    private bool UseVeilAbility(AgentAbilitySlot slot, Vector2 target)
    {
        return slot switch
        {
    ...
    private bool UseVineAbility(AgentAbilitySlot slot, Vector2 target)
    {
        switch (slot)
        {
    ...
    private bool UseNitroAbility(AgentAbilitySlot slot, Vector2 target)
    {
        switch (slot)
        {
            case AgentAbilitySlot.SkillOne:
    ...
    private bool UseOasisAbility(AgentAbilitySlot slot, Vector2 target)
    {
        return slot switch
        {
    ...
    private bool UseDivideAbility(AgentAbilitySlot slot, Vector2 target)
    {
        return slot switch
        {
    ...
    private bool UseGlitchAbility(AgentAbilitySlot slot, Vector2 target)
    {
        switch (slot)
        {
            case AgentAbilitySlot.SkillOne:
