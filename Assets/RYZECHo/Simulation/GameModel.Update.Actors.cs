...
internal sealed partial class GameModel
{
    private void UpdatePlayer(float deltaSeconds, InputSnapshot input)
    {
        ...
        if (movement != Vector2.Empty && !IsActorLockedDown(_player))
        {
        ...
        var aimVector = new Vector2(worldMousePosition.X - _player.Position.X, worldMousePosition.Y - _player.Position.Y);
