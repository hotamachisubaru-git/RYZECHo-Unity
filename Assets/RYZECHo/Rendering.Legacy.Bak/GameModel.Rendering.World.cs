...
internal sealed partial class GameModel
{
    private void DrawWorldPanel(Graphics graphics)
    {
        ...
        {
            new Vector2(WorldBounds.Left + 46f, WorldBounds.Top + 392f),
            new Vector2(WorldBounds.Left + 246f, WorldBounds.Top + 318f),
            new Vector2(WorldBounds.Left + 536f, WorldBounds.Top + 276f),
            new Vector2(WorldBounds.Right - 56f, WorldBounds.Top + 308f),
            new Vector2(WorldBounds.Right - 84f, WorldBounds.Top + 382f),
            new Vector2(WorldBounds.Left + 572f, WorldBounds.Top + 344f),
            new Vector2(WorldBounds.Left + 258f, WorldBounds.Top + 382f),
            new Vector2(WorldBounds.Left + 30f, WorldBounds.Top + 460f),
        }, Color.FromArgb(54, 234, 220, 182), Color.FromArgb(122, 246, 236, 214));
        DrawSignalLane(graphics, new[]
        {
            new Vector2(WorldBounds.Left + 118f, WorldBounds.Top + 562f),
            new Vector2(WorldBounds.Left + 328f, WorldBounds.Top + 440f),
            new Vector2(WorldBounds.Left + 628f, WorldBounds.Top + 418f),
            new Vector2(WorldBounds.Right - 112f, WorldBounds.Top + 468f),
            new Vector2(WorldBounds.Right - 136f, WorldBounds.Top + 516f),
            new Vector2(WorldBounds.Left + 620f, WorldBounds.Top + 472f),
            new Vector2(WorldBounds.Left + 346f, WorldBounds.Top + 490f),
            new Vector2(WorldBounds.Left + 140f, WorldBounds.Top + 610f),
        }, Color.FromArgb(36, 194, 230, 214), Color.FromArgb(98, 224, 240, 236));

        DrawCornerRelay(graphics, new Vector2(WorldBounds.Left + 126f, WorldBounds.Top + 126f), 60f, Color.FromArgb(84, 104, 216, 104));
        DrawCornerRelay(graphics, new Vector2(WorldBounds.Left + 142f, WorldBounds.Bottom - 108f), 72f, Color.FromArgb(84, 94, 214, 122));
        DrawCornerRelay(graphics, new Vector2(WorldBounds.Right - 126f, WorldBounds.Top + 118f), 66f, Color.FromArgb(84, 104, 216, 104));
        DrawCornerRelay(graphics, new Vector2(WorldBounds.Right - 154f, WorldBounds.Bottom - 96f), 78f, Color.FromArgb(84, 94, 214, 122));

        DrawBoardScanner(graphics, new Vector2(WorldBounds.Left + (WorldBounds.Width * 0.52f), WorldBounds.Top + (WorldBounds.Height * 0.52f)), 186f, Color.FromArgb(88, 86, 229, 247));
    ...
    private void DrawTacticalSurface(Graphics graphics)
    {
        ...
        graphics.DrawBezier(pathPen,
            new Vector2(WorldBounds.Left + 118f, WorldBounds.Top + 188f),
            new Vector2(WorldBounds.Left + 312f, WorldBounds.Top + 234f),
            new Vector2(WorldBounds.Left + 612f, WorldBounds.Top + 204f),
            new Vector2(WorldBounds.Right - 142f, WorldBounds.Top + 286f));
        graphics.DrawBezier(pathPen,
            new Vector2(WorldBounds.Left + 138f, WorldBounds.Bottom - 118f),
            new Vector2(WorldBounds.Left + 366f, WorldBounds.Top + 492f),
            new Vector2(WorldBounds.Left + 654f, WorldBounds.Top + 470f),
            new Vector2(WorldBounds.Right - 166f, WorldBounds.Bottom - 104f));
    }

    private void DrawSignalLane(Graphics graphics, Vector2[] points, Color fillColor, Color outlineColor)
    {
    ...
    private void DrawCornerRelay(Graphics graphics, Vector2 center, float radius, Color accent)
    {
    ...
    private void DrawBoardScanner(Graphics graphics, Vector2 center, float radius, Color accent)
    {
    ...
    private void DrawRaisedBlock(Graphics graphics, Rectangle rectangle, Color topColor, Color sideColor, Color outlineColor, float height)
    {
        var sideFace = new[]
        {
            ...
            new Vector2(rectangle.Right + 8f, rectangle.Bottom + height),
            new Vector2(rectangle.Left + 8f, rectangle.Bottom + height),
        };
    ...
    private void DrawWorldEffects(Graphics graphics)
    {
        foreach (var effect in _worldEffects)
        {
            ...
            DrawEffectTag(graphics, new Vector2(effect.Position.X, effect.Position.Y - radius - 18f), label, effect.Color);
        }
    }
    ...
    private void DrawCore(Graphics graphics)
    {
        foreach (var site in GetBombSites())
        {
            ...
            var diamond = new[]
            {
                new Vector2(coreCenter.X, coreCenter.Y - 12f),
                new Vector2(coreCenter.X + 12f, coreCenter.Y),
                new Vector2(coreCenter.X, coreCenter.Y + 12f),
                new Vector2(coreCenter.X - 12f, coreCenter.Y),
            };
