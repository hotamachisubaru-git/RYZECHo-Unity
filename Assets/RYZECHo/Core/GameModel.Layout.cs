...
{
    private Rectangle WorldBounds => new(
        ((_layoutSize.Width - (GridColumns * CellSize)) / 2) - 96,
        88,
        GridColumns * CellSize,
        GridRows * CellSize);
    ...
    private Rectangle SidePanelBounds =>
        new(_layoutSize.Width - WorldMargin - SidePanelWidth, WorldBounds.Top, SidePanelWidth, WorldBounds.Height);

    private Rectangle RosterBounds =>
        new(_layoutSize.Width - WorldMargin - SidePanelWidth, 18, SidePanelWidth, 88);
