...
internal sealed partial class GameModel
{
    ...
    {
        return Encoding.UTF8.GetBytes($"{ProgressIntegrityVersion}|{UnityEngine.Application.identifier}|RYZECHo::Unity");
    }
    ...
    private static string CreateProgressIntegrityStamp(ProgressProfile profile)
    {
        ...
        var payloadBytes = Encoding.UTF8.GetBytes(CreateProgressIntegrityPayload(profile));
        using var hmac = new HMACSHA256(ProgressIntegrityEntropy());
